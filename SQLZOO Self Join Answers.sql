...
--  stops (id,name)
--  route (num,company,pos,stop) see data description here -> http://sqlzoo.net/wiki/Edinburgh_Buses.
 ...
 -- 3. Give the id and the name for the stops on '4' 'LRT' service.
 SELECT stops.id,stops.name
 FROM stops
 JOIN route
 ON stops.id=route.stop
 WHERE route.num='4' and route.compan='LRT'
